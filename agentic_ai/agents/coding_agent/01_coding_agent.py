...
Available Tools:
    ...
    - run_os_command(cmd: str): Takes the system linux os command as input string and executes the command on user's system and returns the output from that command
...
#1. Create a folder named todo_app
#2. Create a TODO app with full CRUD operations  